...
function printTable(){
  ...
  var subjectIndex = subject.selectedIndex;
  var subjectText = subject.options[subjectIndex].text;
  if(subjectText=="과목을 선택하세요") return; // 과목을 선택하지 않았으면 끝낸다.

  var date = document.getElementById("dateSelect");
  var dateIndex = date.selectedIndex;
  var dateString= JSON.parse(date.options[dateIndex].value);

  var jsonData = document.getElementById("resultsJSON");
  ...
  results.forEach(function(result){
    if(result.subject == subjectText && result.date == dateString){
